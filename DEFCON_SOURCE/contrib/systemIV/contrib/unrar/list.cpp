...
static void ListFileAttr(unsigned int A,int HostOS);
...
void ListArchive(CommandData *Cmd)
{
  ...
  unsigned int ArcCount=0,SumFileCount=0;
...
void ListFileAttr(unsigned int A,int HostOS)
{
  switch(HostOS)
  {
    case HOST_MSDOS:
