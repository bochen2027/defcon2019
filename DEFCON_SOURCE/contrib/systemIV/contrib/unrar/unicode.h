...
unsigned char* WideToRaw(const wchar *Src,unsigned char *Dest,int DestSize=0x10000000);
wchar* RawToWide(const unsigned char *Src,wchar *Dest,int DestSize=0x10000000);
