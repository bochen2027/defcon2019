...
void LanguageTable::LoadCurrentLanguage( char *_name )
{
	ClearBaseLanguage();
	ClearTranslation();
...
void LanguageTable::LoadLanguage( char *_filename, BTree<char *> &_langTable, bool _facultative, char *_separators )
{
...
char *LanguageTable::LookupPhraseAdditional(char *_key)
{
    char *result = NULL;
