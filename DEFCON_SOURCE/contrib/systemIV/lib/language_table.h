...
protected:
	...
	void        LoadLanguage        (char *_filename, BTree<char *> &_langTable, bool _facultative = false, char *_separators = NULL);
...
public:
	...
	void        LoadCurrentLanguage     (char *_name = NULL);
	...
	char        *LookupPhraseAdditional (char *_key);
